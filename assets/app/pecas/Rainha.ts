...
export class Rainha extends Peca {
    ...
    indisponiveisAoReiAdversario() {
        ...
        const casasAhMarcar = new Array()
            .concat(
                this.marcacaoEspecial(this.casas_topo_direita(linha, coluna)),
                this.marcacaoEspecial(this.casas_topo_esquerda(linha, coluna)),
                this.marcacaoEspecial(this.casas_baixo_direita(linha, coluna)),
                this.marcacaoEspecial(this.casas_baixo_esquerda(linha, coluna)),
                this.marcacaoEspecial(this.casas_a_Frente(linha, coluna)),
                this.marcacaoEspecial(this.casas_a_tras(linha, coluna)),
                this.marcacaoEspecial(this.casas_a_direita(linha, coluna)),
                this.marcacaoEspecial(this.casas_a_esquerda(linha, coluna))
            )
