    ...
    iniciarCavalos() {
        ...
        for (let i = 0; i < cavalos.length; i++) {
            ...
            cavalos[i].addEventListener("click", function () {
                if (inst_jogador.vez)
                    inst_cavalo.mostrarDisponiveis();
            });
        }
    }
    iniciarTorres() {
    ...
    iniciarRei() {
        ...
        for (let i = 0; i < reis.length; i++) {
            ...
            reis[i].addEventListener("click", function () {
                if (inst_jogador.vez)
                    rei.mostrarDisponiveis(inst_jogador.casasIndisponiveisAoRei);
            });
        }
    }
